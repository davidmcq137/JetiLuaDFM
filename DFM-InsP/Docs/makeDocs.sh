...
pandoc ~/JS/Gauges/resources/gauges/en-HarryCBdial.md -f markdown -t html  -o ~/JS/DFM-InsP/Panels/EN-HARRYCBDIAL.HTML --metadata title="Harry C. CB Dial Panel" --template="jeti.html"
cp ~/JS/DFM-InsP/Panels/EN-HARRYCBDIAL.HTML ~/JSE/DOCS/DFM-INSP/

pandoc ~/JS/Gauges/resources/gauges/en-HarryElectric.md -f markdown -t html  -o ~/JS/DFM-InsP/Panels/EN-HARRYELECTRIC.HTML --metadata title="Harry C. Electric panel" --template="jeti.html"
cp ~/JS/DFM-InsP/Panels/EN-HARRYELECTRIC.HTML ~/JSE/DOCS/DFM-INSP/

pandoc ~/JS/Gauges/resources/gauges/en-ChartRecorder.md -f markdown -t html -o ~/JS/DFM-InsP/Panels/EN-CHARTRECORDER.HTML --metadata title="Chart Recorder Two Trace Panel" --template="jeti.html"
cp ~/JS/DFM-InsP/Panels/EN-CHARTRECORDER.HTML ~/JSE/DOCS/DFM-INSP/

pandoc ~/JS/Gauges/resources/gauges/en-Concentric.md -f markdown -t html -o ~/JS/DFM-InsP/Panels/EN-CONCENTRIC.HTML --metadata title="Concentric Gauges Panel" --template="jeti.html"
cp ~/JS/DFM-InsP/Panels/EN-CONCENTRIC.HTML ~/JSE/DOCS/DFM-INSP/

pandoc ~/JS/Gauges/resources/gauges/en-ElectricArc.md -f markdown -t html -o ~/JS/DFM-InsP/Panels/EN-ELECTRICARC.HTML --metadata title="Electric Panel with Arc Gauges" --template="jeti.html"
cp ~/JS/DFM-InsP/Panels/EN-ELECTRICARC.HTML ~/JSE/DOCS/DFM-INSP/

pandoc ~/JS/Gauges/resources/gauges/en-FourUp.md -f markdown -t html -o ~/JS/DFM-InsP/Panels/EN-FOURUP.HTML --metadata title="Four Gauge Panel" --template="jeti.html"
cp ~/JS/DFM-InsP/Panels/EN-FOURUP.HTML ~/JSE/DOCS/DFM-INSP/

pandoc ~/JS/Gauges/resources/gauges/en-GlassCockpit.md -f markdown -t html -o ~/JS/DFM-InsP/Panels/EN-GLASSCOCKPIT.HTML --metadata title="Glass Cockpit Panel" --template="jeti.html"
cp ~/JS/DFM-InsP/Panels/EN-GLASSCOCKPIT.HTML ~/JSE/DOCS/DFM-INSP/

pandoc ~/JS/Gauges/resources/gauges/en-HarryCBdial.md -f markdown -t html -o ~/JS/DFM-InsP/Panels/EN-HARRYCBDIAL.HTML --metadata title="Harry C. CB Dial Panel" --template="jeti.html"
cp ~/JS/DFM-InsP/Panels/EN-HARRYCBDIAL.HTML ~/JSE/DOCS/DFM-INSP/

pandoc ~/JS/Gauges/resources/gauges/en-HarryElectric.md -f markdown -t html -o ~/JS/DFM-InsP/Panels/EN-HARRYELECTRIC.HTML --metadata title="Harry C. Elecric Panel" --template="jeti.html"
cp ~/JS/DFM-InsP/Panels/EN-HARRYELECTRIC.HTML ~/JSE/DOCS/DFM-INSP/

pandoc ~/JS/Gauges/resources/gauges/en-PreFlightArc.md -f markdown -t html -o ~/JS/DFM-InsP/Panels/EN-PREFLIGHTARC.HTML --metadata title="Preflight Panel with Arg Gauges" --template="jeti.html"
cp ~/JS/DFM-InsP/Panels/EN-PREFLIGHTARC.HTML ~/JSE/DOCS/DFM-INSP/

pandoc ~/JS/Gauges/resources/gauges/en-PreFlightCBox.md -f markdown -t html -o ~/JS/DFM-InsP/Panels/EN-PREFLIGHTCBOX.HTML --metadata title="PreFlight Central Box Panel" --template="jeti.html"
cp ~/JS/DFM-InsP/Panels/EN-PREFLIGHTCBOX.HTML ~/JSE/DOCS/DFM-INSP/

pandoc ~/JS/Gauges/resources/gauges/en-RickDFour.md -f markdown -t html -o ~/JS/DFM-InsP/Panels/EN-RICKDFOUR.HTML --metadata title="Rick D DA-200 Panel" --template="jeti.html"
cp ~/JS/DFM-InsP/Panels/EN-RICKDFOUR.HTML ~/JSE/DOCS/DFM-INSP/

pandoc ~/JS/Gauges/resources/gauges/en-RickFive.md -f markdown -t html -o ~/JS/DFM-InsP/Panels/EN-RICKFIVE.HTML --metadata title="Rick D Radial Panel" --template="jeti.html"
cp ~/JS/DFM-InsP/Panels/EN-RICKFIVE.HTML ~/JSE/DOCS/DFM-INSP/

pandoc ~/JS/Gauges/resources/gauges/en-TurbineArc.md -f markdown -t html -o ~/JS/DFM-InsP/Panels/EN-TURBINEARC.HTML --metadata title="Turbine Panel with Arc Gauges" --template="jeti.html"
cp ~/JS/DFM-InsP/Panels/EN-TURBINEARC.HTML ~/JSE/DOCS/DFM-INSP/

pandoc ~/JS/Gauges/resources/gauges/en-Turbine.md -f markdown -t html -o ~/JS/DFM-InsP/Panels/EN-TURBINE.HTML --metadata title="Turbine Panel" --template="jeti.html"
cp ~/JS/DFM-InsP/Panels/EN-TURBINE.HTML ~/JSE/DOCS/DFM-INSP/

pandoc ~/JS/Gauges/resources/gauges/en-TwoLargeArc.md -f markdown -t html -o ~/JS/DFM-InsP/Panels/EN-TWOLARGEARC.HTML --metadata title="Two Large Gauge Panel" --template="jeti.html"
cp ~/JS/DFM-InsP/Panels/EN-TWOLARGEARC.HTML ~/JSE/DOCS/DFM-INSP/

pandoc ~/JS/Gauges/resources/gauges/en-TwoLarge.md -f markdown -t html -o ~/JS/DFM-InsP/Panels/EN-TWOLARGE.HTML --metadata title="Two Large Gauge Panel" --template="jeti.html"
