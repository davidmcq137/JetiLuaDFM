...
while true do
   local ll = io.read()
   if not ll then print("EOF?") barf() end
   local l = string.sub(ll, 1, #ll-1)
   if string.sub(l, 1, 1) == "G" then
      filehash = string.sub(ll, 2, #l) 
      break
   end
   crc16add(l)
end
...
if r == filehash then print("Match") else print("No Match") end
