...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_42161 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_42161(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_42162 = (function (reader){
var x__4463__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_42162(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_42163 = (function (reader,ch){
var x__4463__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_42163(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_42164 = (function (reader){
var x__4463__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_42164(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_42165 = (function (reader){
var x__4463__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_42165(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_42166 = (function (reader){
var x__4463__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_42166(reader);
}
});
...
var G__42193 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__42194 = s.append(c);
c = G__42193;
s = G__42194;
continue;
}
