...
var len__4771__auto___47074 = arguments.length;
var i__4772__auto___47075 = (0);
while(true){
if((i__4772__auto___47075 < len__4771__auto___47074)){
args_arr__4792__auto__.push((arguments[i__4772__auto___47075]));

var G__47082 = (i__4772__auto___47075 + (1));
i__4772__auto___47075 = G__47082;
continue;
} else {
}
break;
...
/** @this {Function} */
(shadow.util.log.cljs$lang$applyTo = (function (seq46964){
var G__46965 = cljs.core.first(seq46964);
var seq46964__$1 = cljs.core.next(seq46964);
var G__46966 = cljs.core.first(seq46964__$1);
var seq46964__$2 = cljs.core.next(seq46964__$1);
var G__46967 = cljs.core.first(seq46964__$2);
var seq46964__$3 = cljs.core.next(seq46964__$2);
var G__46968 = cljs.core.first(seq46964__$3);
var seq46964__$4 = cljs.core.next(seq46964__$3);
var G__46969 = cljs.core.first(seq46964__$4);
var seq46964__$5 = cljs.core.next(seq46964__$4);
var G__46970 = cljs.core.first(seq46964__$5);
var seq46964__$6 = cljs.core.next(seq46964__$5);
var self__4758__auto__ = this;
return self__4758__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46965,G__46966,G__46967,G__46968,G__46969,G__46970,seq46964__$6);
}));

(shadow.util.log.cljs$lang$maxFixedArity = (6));

shadow.util.remove_from_vector = (function shadow$util$remove_from_vector(coll,key){
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (v,p__47041){
var vec__47042 = p__47041;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47042,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47042,(1),null);
